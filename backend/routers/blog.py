...
# 获取文章的评论
@router.get("/posts/{post_id}/comments/", response_model=list[BlogComment])
...
# 获取文章的点赞
@router.get("/posts/{post_id}/likes/", response_model=list[BlogLike])
...
# 创建文章的点赞
@router.post("/posts/{post_id}/likes/", response_model=BlogLike)
